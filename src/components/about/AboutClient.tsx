...
export function AboutClient({ initialDepartments, initialTestimonials }: AboutClientProps) {
    const [selectedDept, setSelectedDept] = React.useState<Department | null>(null);
    const [selectedMember, setSelectedMember] = React.useState<TeamMember | null>(null);

    return (
        <main className="min-h-screen bg-black pt-32 relative overflow-hidden">
            {/* Background Decor */}
                ...
                <div className="container mx-auto px-6">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-center">
                        <div className="space-y-2">
                            <h3 className="text-5xl font-display font-bold text-white">120+</h3>
                            <p className="text-pink-500 font-mono tracking-widest uppercase text-sm">Active Members</p>
                        </div>
                        <div className="space-y-2">
                            <h3 className="text-5xl font-display font-bold text-white">4</h3>
                            <p className="text-purple-500 font-mono tracking-widest uppercase text-sm">Major Activities</p>
                        </div>
                        <div className="space-y-2">
                            <h3 className="text-5xl font-display font-bold text-white">5</h3>
            ...
            <section className="container mx-auto px-6 py-32 relative z-10 border-b border-white/5">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                    ...
                    >
                        ...
                        <div className="grid grid-cols-2 gap-8 pt-4">
                            <div>
                                ...
                                <p className="text-neutral-500 text-sm uppercase tracking-wider">Years of Impact</p>
                            </div>
                            <div>
                                <h4 className="text-white font-bold text-3xl mb-1">500+</h4>
                                <p className="text-neutral-500 text-sm uppercase tracking-wider">Alumni Members</p>
                            </div>
                        </div>
                    </motion.div>
                    <motion.div
                    ...
                    >
                        ...
                        <div className="absolute bottom-10 left-10">
                            <span className="text-white font-bold text-lg">Since 2014.</span>
                        </div>
                    </motion.div>
                </div>
            </section>
            ...
            <section id="departments" className="container mx-auto px-6 py-32 relative z-10">
                <div className="text-center mb-20">
                    <h2 className="text-4xl md:text-5xl font-display font-bold text-white mb-6 uppercase tracking-tighter">Our Departments</h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {initialDepartments.map((dept, i) => {
                        ...
                        return (
                            ...
                            >
                                <div className={`p-4 rounded-2xl bg-black/40 ${dept.iconColor} w-fit mb-6 shadow-xl group-hover:scale-110 transition-transform`}>
                                    <IconComponent size={24} />
                                </div>
                                <h3 className="text-2xl font-bold text-white mb-4 uppercase tracking-tight">{dept.name}</h3>
                    ...
                    {selectedDept && (
                        <div className="fixed inset-0 z-[80] flex items-center justify-center p-6 sm:p-10 pointer-events-auto">
                            ...
                            <motion.div
                                ...
                                className="relative max-w-4xl w-full bg-neutral-900 border border-white/10 rounded-[2.5rem] overflow-hidden shadow-2xl z-10 p-8 md:p-12 overflow-y-auto max-h-[90vh]"
                            >
                                <button
                                    onClick={() => setSelectedDept(null)}
                                ...
                                <div className="flex items-center gap-4 mb-10">
                                    <div className={`p-3 rounded-xl bg-black/40 ${selectedDept.iconColor}`}>
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                                    {selectedDept.members.map((member, index) => (
                                        ...
                                        >
                                            ...
                                            <h4 className="text-white font-bold text-lg mb-1 uppercase tracking-tight">{member.name}</h4>
                ...
                {selectedMember && (
                    <div className="fixed inset-0 z-[100] flex items-center justify-center p-6 sm:p-10 pointer-events-auto">
                        ...
                        <motion.div
                            ...
                            animate={{ scale: 1, opacity: 1, y: 0 }}
                            exit={{ scale: 0.9, opacity: 0, y: 30 }}
                            className="relative max-w-xl w-full bg-neutral-900/90 rounded-[2rem] overflow-hidden border border-white/10 shadow-[0_0_80px_rgba(0,0,0,0.5)] z-10 flex flex-col backdrop-blur-md"
                        >
                            <button
                                onClick={() => setSelectedMember(null)}
                            ...
                            <div className="h-48 md:h-64 relative overflow-hidden group">
                                ...
                                <div className="absolute bottom-6 left-8">
                                    <motion.h2
                                        ...
                                        transition={{ delay: 0.2 }}
                                        className="text-3xl md:text-4xl font-bold text-white mb-1 uppercase tracking-tight"
                                    >
                                        {selectedMember.name}
                                    </motion.h2>
                                    <motion.span
                            ...
                            <div className="p-8 md:p-10 relative">
                                ...
                                <div className="space-y-8 relative z-10">
                                    ...
                                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6 pt-6 border-t border-white/5">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                                ...
                                                <a
                                                    ...
                                                    className="text-white hover:text-pink-500 transition-colors text-sm font-semibold border-b border-transparent hover:border-pink-500/30 font-mono"
                                                >
                                        ...
                                        <div className="flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 text-neutral-400 text-xs font-mono uppercase tracking-widest">
            ...
            <section className="py-32 bg-black relative overflow-hidden">
                <div className="container mx-auto px-6 relative z-10 mb-16 text-center">
                    ...
                    <h2 className="text-4xl md:text-6xl font-display font-bold text-white mb-6">What our family says</h2>
                </div>
                ...
                <div className="relative w-full overflow-hidden group">
                    ...
                    <div className="flex gap-6 animate-marquee hover:[animation-play-state:paused] w-max px-4">
                        {[...initialTestimonials, ...initialTestimonials].map((item, index) => (
                            <div
                                key={index}
                                className="w-[300px] md:w-[400px] bg-neutral-900/50 border border-white/5 rounded-[2rem] p-8 backdrop-blur-sm hover:bg-neutral-800/50 transition-colors shrink-0 flex flex-col relative"
                            >
            ...
            <section className="container mx-auto px-6 py-40 text-center relative z-10">
                <div className="max-w-4xl mx-auto">
                    <h2 className="text-5xl md:text-7xl font-display font-bold text-white mb-16 px-4">
                        FOLLOW US IN <br />
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        >
                            ...
                            <span className="text-white font-bold text-xl tracking-widest group-hover:text-[#1877F2] transition-colors uppercase">Facebook</span>
                        </a>
                        ...
                        >
                            ...
                            <span className="text-white font-bold text-xl tracking-widest group-hover:text-pink-500 transition-colors uppercase">Instagram</span>
                        </a>
                        ...
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="group p-10 rounded-[2.5rem] bg-white/5 border border-white/10 hover:bg-neutral-800/50 transition-all flex flex-col items-center gap-6"
                        >
                            ...
                            <span className="text-white font-bold text-xl tracking-widest group-hover:text-[#00f2ea] transition-colors uppercase">TikTok</span>
                        </a>
                    </div>
                </div>
            </section>
