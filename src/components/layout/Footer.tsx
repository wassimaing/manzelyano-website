...
export function Footer() {
    return (
        <footer id="contact" className="w-full bg-[#050505] border-t border-white/10 pt-20 pb-10 mt-12 relative z-20">
            ...
            <div className="max-w-[1200px] mx-auto px-6">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
                    ...
                    <div className="col-span-1 lg:col-span-1">
                        <div className="flex items-center gap-4 mb-6">
                            {/* Small Logo Icon */}
                            <div className="w-12 h-12 rounded-xl bg-white p-1 shadow-[0_0_15px_rgba(255,255,255,0.2)]">
                                <img
                                    src="/images/logo.png"
                                    alt="Logo"
                    ...
                    {/* Map */}
                    <div className="col-span-1 h-48 rounded-2xl overflow-hidden border border-white/10 relative group">
                        <iframe
                ...
                <div className="pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-4">
                    ...
                    <div className="flex gap-4 items-center px-3 py-1 bg-white/5 rounded-full border border-white/5">
