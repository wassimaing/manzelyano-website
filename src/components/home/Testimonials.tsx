...
export function Testimonials({ initialTestimonials }: TestimonialsProps) {
    const data = initialTestimonials && initialTestimonials.length > 0 ? initialTestimonials : staticTestimonials;
    ...
    return (
        <section className="relative w-full py-20 overflow-hidden dark:bg-black bg-white z-20">
            ...
            >
                <div className="absolute left-0 top-0 bottom-0 w-24 md:w-40 dark:bg-gradient-to-r dark:from-black dark:to-transparent bg-gradient-to-r from-white to-transparent z-20 pointer-events-none" />
                <div className="absolute right-0 top-0 bottom-0 w-24 md:w-40 dark:bg-gradient-to-l dark:from-black dark:to-transparent bg-gradient-to-l from-white to-transparent z-20 pointer-events-none" />
                ...
                >
                    {[...data, ...data, ...data, ...data].map((item, index) => (
                        <div
                            key={index}
                            className={cn(
                                "w-[300px] md:w-[400px] dark:bg-neutral-900/50 bg-neutral-100/80 dark:border-white/5 border-neutral-200 border rounded-2xl p-8 backdrop-blur-sm dark:hover:bg-neutral-800/50 hover:bg-neutral-200/80 transition-colors shrink-0 flex flex-col relative"
                            )}
                        >
