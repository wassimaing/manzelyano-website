...
import { Event, events as staticEvents } from "@/data/events";
...
export function Events({ initialEvents }: EventsProps) {
    const data = initialEvents && initialEvents.length > 0 ? initialEvents : staticEvents;
        ...
        <section id="events" className="relative w-full py-16 md:py-24 px-4 md:px-8 z-20">
                ...
                >
                    ...
                    <div className="relative z-10 p-6 sm:p-8 md:p-12">
                        <div className="flex flex-wrap items-center justify-between gap-3 mb-8">
                            ...
                            <span className="dark:text-neutral-500 text-neutral-800 font-mono text-xs font-bold">
                                {featuredEvent.date}
                            </span>
                        </div>
            ...
            >
                <div className="flex items-center justify-between px-6 py-4 border-b dark:border-white/5 border-neutral-200">
                    ...
                    <Link
                        href="/events"
                        className="text-xs dark:text-neutral-400 text-neutral-500 dark:hover:text-white hover:text-neutral-900 transition-colors flex items-center gap-1.5 group"
                    >
                        View all
