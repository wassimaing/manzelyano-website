...
export function Events({ initialEvents = [] }: { initialEvents?: Event[] }) {
                    ...
                    <div className="relative z-10 p-6 sm:p-8 md:p-12">
                        ...
                        <div className="flex flex-wrap items-center justify-between gap-3 mb-8">
                            ...
                            <span className="dark:text-neutral-500 text-neutral-800 font-mono text-xs font-bold">
                                {formatEventDate(featuredEvent.startDate, featuredEvent.endDate, featuredEvent.date)}
                                {formatEventTime(featuredEvent.timeline) && ` • ${formatEventTime(featuredEvent.timeline)}`}
                            </span>
                        </div>
